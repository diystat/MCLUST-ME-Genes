...
saveRDS(res.mcme, "Paper edit/Edit results/mcme_res.rds")
...
plot(rand.samples, col=c("red","dodgerblue")[cl.mevvv], pch=c(15,16)[cl.mevvv])
par(mfrow=c(1,1))
...
res.mcme = readRDS("Paper edit/Edit results/mcme_res.rds")
res.mevvv = readRDS("Paper edit/Edit results/mevvv_res.rds")
z1.mcme = res.mcme$z[,1]
z1.mevvv = res.mevvv$z[,1]


plot(z1.mevvv, z1.mcme)
abline(0,1,lty="dashed")
abline(v=0.5, h=0.5, lty="dashed")
