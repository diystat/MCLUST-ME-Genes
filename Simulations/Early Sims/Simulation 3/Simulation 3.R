      ...
      #---------------------Cluster Simulation 3--------------------------#
      
      ### Both clusters have randomly generated errors
...
par(mfrow=c(5,3))
res50_rr = sapply(seedvec,sim3,n=50)
par(mfrow=c(1,1))
dev.off()  

png("100-R.png",900,1500)
par(mfrow=c(5,3))
res100_rr = sapply(seedvec,sim3,n=100)
par(mfrow=c(1,1))
dev.off()
...
par(mfrow=c(5,3))
res200_rr = sapply(seedvec,sim3,n=200)
par(mfrow=c(1,1))
dev.off()
...
par(mfrow=c(5,3))
res500_rr = sapply(seedvec,sim3,n=500)
par(mfrow=c(1,1))
dev.off()
...
par(mfrow=c(5,3))
res800_rr = sapply(seedvec,sim3,n=800)
par(mfrow=c(1,1))
dev.off()


out = list(res50=res50_rr,res100=res100_rr,res200=res200_rr,res500=res500_rr,res800=res800_rr)
save(out,file="sim3res")
