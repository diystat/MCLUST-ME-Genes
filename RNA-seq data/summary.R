...
## estiamtion error matrices are mostly diagonal matrices. Can we simplify the EM algorithm in this case?

## genewise dispersion model: dispersion the same for each gene, different for differnet samples. Estimate dispersion from original data.

  

## Other optimization methods: can added
